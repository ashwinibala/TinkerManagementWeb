...
const HomeHeader = () => {
  return (
    ...
    <div>
            ...
            <div
                class="relative overflow-hidden bg-cover bg-no-repeat imageCss"
                >
                ...
                <div class="flex h-full items-center justify-center">
                    ...
                    <h1 class="mb-6 text-5xl font-bold">Tinker Services</h1>
                    <h3 class="mb-8 text-3xl font-bold">Your Trusted Handyman for Every Task!!!</h3>
                    {/* <button
                        type="button"
